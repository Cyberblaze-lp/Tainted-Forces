...
recipes.addShaped(<immersiveengineering:conveyor>.withTag({conveyorType: "immersiveengineering:conveyor"}) * 4, [[<ore:itemLeather>, <ore:itemLeather>, <ore:itemLeather>], [<ore:support>, <ore:support>, <ore:support>]]);

...
mods.thaumcraft.Infusion.registerRecipe("Cloning", "CLONING", <sync:item_shell_constructor>, 1, [<aspect:machina>*10, <aspect:permutatio>*10, <aspect:victus>*50, <aspect:humanus>*20], <thaumcraft:metal_alchemical>, [<ore:blockCopper>,<railcraft:glass:*>,<railcraft:glass:*>,<railcraft:glass:*>,<ore:blockCopper>,<railcraft:glass:*>,<railcraft:glass:*>,<railcraft:glass:*>]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("bettersmelter", "ESSENTIASMELTER@2", 50, [<aspect:ignis>], <thaumcraft:smelter_basic>, [[<tfc:brass_mechanisms>, <tfc:ceramics/fired/fire_brick>,<tfc:brass_mechanisms>],[<tfc:ceramics/fired/fire_brick>,<ore:plateLead>, <tfc:ceramics/fired/fire_brick>],[<tfc:ceramics/fired/fire_brick>,<ore:plateLead>, <tfc:ceramics/fired/fire_brick>]]);

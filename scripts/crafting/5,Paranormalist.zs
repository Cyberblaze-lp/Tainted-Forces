...
mods.thaumcraft.Infusion.registerRecipe("FLEXPACK", "THAUMOSTATIC_HARNESS", <thaumicaugmentation:thaumostatic_harness>,10, [<aspect:potentia>*50,<aspect:machina>*25, <aspect:volatus>*25, <aspect:motus>*25],<minecraft:leather_chestplate>,[<thaumcraft:nugget:10>,<thaumcraft:nugget:10>,<ore:plateBrass>, <ore:plateBrass>, <thaumcraft:metal_alchemical>,<thaumcraft:plank_greatwood>,<thaumcraft:plank_greatwood>,<thaumcraft:mind>]);
mods.thaumcraft.Infusion.registerRecipe("RADIOBEACON", "THAUMOSTATIC_HARNESS",<cyberware:beacon_large>,10, [<aspect:aer>*50 , <aspect:volatus>*20, <aspect:permutatio>*20, <aspect:potentia>*20],<thaumcraft:metal_alchemical>,[<thaumcraft:tube>,<thaumcraft:tube>,<thaumcraft:nugget:10>,<thaumcraft:tube>,<thaumcraft:tube>,<thaumcraft:nugget:10>]);

...
//Adding Restricted Blocks
	...
	//tfc vein- related stuff
	addRestriction( true, true, [0], <thaumcraft:sapling_silverwood>);
	addRestriction( true, true, [0], <modularmachinery:burnerdrill_t1_controller>);
